...
export default function AccountingRegistration({
  ...
  const grandTotal = Math.floor((totalSupplyValue + totalVat) / 10) * 10; 
          ...
          <table className={styles.table}>
            ...
            <tbody>
              {loading ? (
                ...
                const clientGrandTotal = Math.floor((clientSupply + clientVat) / 10) * 10;
                ...
                return processedDetails.map((calc, idx) => {
                  ...
                  return (
                    <tr key={calc.inventory_id} style={{ 
                      ...
                      <td className={styles.td} style={{ textAlign: 'right', verticalAlign: 'bottom', padding:'12px' }}>
